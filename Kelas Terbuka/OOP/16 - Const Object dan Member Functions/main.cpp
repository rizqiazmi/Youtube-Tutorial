...
class Hero{
    ...
    public:
        ...
        // member function ini tidak akan bisa, karena attribute nya tidak const
        // void setName(const char* name) {
        //    this->name = name;
        //}
...
int main(int argc, char const *argv[]) {
    ...
    const Hero hero2 = Hero("Ucup");// object konstan tidak bisa kita rubah isinya
    hero1.display();
    ...
    // kesimpulan
    // 1. jika object nya tidak const, maka seluruh member bisa di panggil
